...
export default function ChallengesList() {
  ...
  if (loading) return <div style={{ padding: '20px', color: '#ef6c00', fontWeight: 'bold' }}>Cargando retos de programación desde el servidor...</div>;
        ...
        {challenges.map((challenge) => (
          <div key={challenge.id} style={{ border: '1px solid #e0e0e0', padding: '15px', borderRadius: '8px', backgroundColor: '#fff' }}>
            <h3 style={{ margin: '0 0 10px 0' }}>
              {challenge.title}{' '}
              <span style={{ fontSize: '12px', padding: '4px 8px', borderRadius: '12px', backgroundColor: challenge.difficulty === 'Easy' ? '#e8f5e9' : '#fff3e0', color: challenge.difficulty === 'Easy' ? '#2e7d32' : '#ef6c00', marginLeft: '10px' }}>
